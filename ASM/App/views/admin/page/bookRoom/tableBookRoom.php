    ...
    <section class="section">
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="card tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab"
                 tabindex="0">
                <div class="card-body">
                    <a href="<?=ROOT_URL?>?url=BookRoomAdminController/store" class="btn btn-success">Thêm</a>
                    <table class='table table-striped' id="table">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?=ROOT_URL?>?url=BookRoomAdminController/updatStatusInfo/<?=$value['bookroomId']?>" class="btn btn-info">Xác nhận</a>
                            </td>
                        </tr>
