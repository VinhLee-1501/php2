                ...
                <div class="card pt-4">
                    <div class="card-body">
                        <div class="text-center mb-5">
                            <img src="../../voler-master/dist/assets/images/favicon.svg" height="48" class='mb-4'>
                            <h3>Sign In</h3>
                        ...
                        <form action="home.php">
                            ...
                            <div class='form-check clearfix my-4'>
                                ...
                                <div class="float-right">
                                    <a href="../../../dist/auth-register.html">Don't have an account?</a>
                                </div>
                            </div>
                            <div class="clearfix">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <button class="btn btn-block mb-2 btn-primary"><i data-feather="facebook"></i> Facebook
                                </button>
                            </div>
                            <div class="col-sm-6">
                                <button class="btn btn-block mb-2 btn-secondary"><i data-feather="github"></i> Github
                                </button>
                            </div>
                        </div>
                    </div>
