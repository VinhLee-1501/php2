            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action="<?=ROOT_URL?>?url=RoomAdminController/updateInfoRoom/<?=$data[0]['roomId']?>" method="post">
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                                   ...
                                                   name="nameRoom" value="<?=$data[0]['nameRoom']?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
...
<!--                                    </div>-->
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="describtion"><?=$data[0]['describtion']?></textarea>
                                        </div>
                                    </div>
