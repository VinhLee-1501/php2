                    ...
                    <div class="nav-menu">
                        <nav class="mainmenu">
                            <ul>
                                ...
                                <li><a href="?page=Rooms">Phòng</a></li>
                                <li><a href="?page=aboutUs">Giới thiệu</a></li>
                                <li><a href="#">Trang</a>
                                    <ul class="dropdown">
                                        <li><a href="?page=detail_room">Room Details</a></li>
                                        <li><a href="?page=detailBolg">Blog Details</a></li>
                                        <li><a href="#">Family Room</a></li>
                                        <li><a href="#">Premium Room</a></li>
                                    </ul>
                                </li>
                                <li><a href="?page=blogs">Tin tức</a></li>
